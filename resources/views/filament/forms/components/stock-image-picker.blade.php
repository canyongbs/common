...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    >
        <x-filament::input.wrapper inline-prefix prefix-icon="heroicon-m-magnifying-glass">
            <x-filament::input type="search" x-model="query" placeholder="Search stock images..." />
        </x-filament::input.wrapper>

        <div class="flex justify-center py-8" x-show="loading">
        ...
        >
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-danger-700 dark:text-danger-200 text-sm" x-text="error"></p>
                </div>
            </div>
        </div>

        <div class="text-sm text-gray-600 dark:text-gray-400" x-show="! loading && ! error && total > 0">
            Showing
        ...
        <div class="py-12 text-center" x-show="! loading && ! error && images.length === 0 && ! query.trim()">
        ...
        >
            <template x-for="image in images" x-bind:key="image.url">
                ...
                >
                    ...
                    >
                        <p class="truncate text-xs font-medium text-white" x-text="image.title"></p>
                    </div>
                </div>
            </template>
        </div>

        <div class="flex items-center justify-between" x-show="! loading && ! error && lastPage > 1">
        ...
        <div class="mt-4 rounded-lg bg-gray-50 p-4 dark:bg-gray-800" x-show="selectedImage">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    ></p>
                    <p class="truncate text-sm text-gray-500 dark:text-gray-400" x-text="selectedImage?.url"></p>
                </div>
