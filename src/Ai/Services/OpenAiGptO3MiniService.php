...
class OpenAiGptO3MiniService extends BaseOpenAiService implements AiServiceLifecycleHooks
{
    ...
    public function __construct(
        ...
        $this->client = OpenAI::factory()
            ...
            ->withHttpHeader('api-key', $this->settings->open_ai_gpt_o3_mini_api_key ?? config('integration-open-ai.gpt_o3_mini_api_key'))
            ->withQueryParam('api-version', config('integration-open-ai.gpt_o3_mini_api_version'))
    ...
    {
        return $this->settings->open_ai_gpt_o3_mini_api_key ?? config('integration-open-ai.gpt_o3_mini_api_key');
    }

    public function getApiVersion(): string
    {
        return config('integration-open-ai.gpt_o3_mini_api_version');
    }

    public function getModel(): string
    {
        return $this->settings->open_ai_gpt_o3_mini_model ?? config('integration-open-ai.gpt_o3_mini_model');
    }

    public function getDeployment(): ?string
    {
        return $this->settings->open_ai_gpt_o3_mini_base_uri ?? config('integration-open-ai.gpt_o3_mini_base_uri');
    }
