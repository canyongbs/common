...
if (! is_file($testbench)) {
    fwrite(STDOUT, 'Skipping common:compile-guidance: dev dependencies are not installed.' . PHP_EOL);

    exit(0);
}

$command = escapeshellarg(PHP_BINARY) . ' ' . escapeshellarg($testbench) . ' common:compile-guidance';
