...
it('preserves the notification content and uses its ID as the browser tag', function () {
    ...
    $message = $notification->toWebPush(new BrowserNotificationUser(), $notification)->toArray();
    ...
    expect($message)->toMatchArray([
        ...
        'data' => [
            'common_browser_notification' => true,
            'notification_id' => '123e4567-e89b-12d3-a456-426614174000',
            'action_url' => '/requests/123',
            'open_in_new_tab' => true,
        ],
    ])->and($notification->getSubscriptionId())->toBe('subscription-id');
});
